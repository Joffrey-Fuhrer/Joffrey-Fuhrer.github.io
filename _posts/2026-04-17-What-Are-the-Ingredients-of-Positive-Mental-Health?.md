...
<div style="font-family: 'Georgia', serif; background-color: rgba(0, 0, 0, 0.6); padding: 2rem; border: 1px solid #444; max-width: 700px; margin: auto; box-shadow: 0 0 10px #000;">
  <h2 style="text-align: center; font-variant: small-caps; color: #ffffff;">What Are the Ingredients of Positive Mental Health?</h2>
  ...
  <p style="font-size: 1.1rem; line-height: 1.7; color: #ffffff;">
    And here comes the most interesting part of this article: instead of focusing on disagreements, what are the key ingredients experts in the field would actually agree on? Through their methodology, the authors narrowed down this list to nine dimensions (each exceeding 90% agreement), including <strong>"meaning and purpose"</strong>, <strong>"life satisfaction"</strong>, <strong>"self-acceptance"</strong>, <strong>"connection"</strong>, <strong>"autonomy"</strong>, and <strong>"happiness"</strong>! Happy to see I was not too far from this consensus!
  </p>
